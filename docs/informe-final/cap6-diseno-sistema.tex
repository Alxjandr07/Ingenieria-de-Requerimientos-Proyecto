...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{c4-nivel1-contexto.png}
  \caption{Diagrama C4 nivel 1 --- Contexto del sistema SGROAS.}
  \label{fig:c4-nivel1}
\end{figure}
...
\begin{itemize}
  ...
  \item \textbf{Backend (Spring Boot 3.2.x / Java 21 LTS):} API REST con controladores, servicios y repositorios. Empaquetado como JAR ejecutable.
...
\begin{figure}[H]
  ...
  \caption{Diagrama C4 nivel 2 --- Contenedores del sistema SGROAS.}
  \label{fig:c4-nivel2}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{c4-nivel3-componentes.png}
  \caption{Diagrama C4 nivel 3 --- Componentes del backend SGROAS.}
  \label{fig:c4-nivel3}
\end{figure}
