...
\begin{enumerate}
  ...
  \item \textbf{Evidencia de calidad:} 222 pruebas JUnit 5 con JaCoCo núcleo 87,5\% instrucciones / 87,9\% ramas (95,5\% líneas, paquete \texttt{abd} excluido), análisis estático SpotBugs 4.8.6 (0 hallazgos), escaneo OWASP ZAP baseline (0 High / 2 Med) y pruebas de carga k6 (3 corridas, media 23,01\,ms, p95 máx 173,13\,ms).
