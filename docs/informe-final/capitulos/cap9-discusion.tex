...
\textbf{RQ3 (usabilidad).} La media SUS de 68,5 (IC\,95\,\% [60,76; 76,24], n=15)
...
generalistas medidos en \cite{kortum2013}, el valor se acerca al rango típico de
aplicaciones web ($\approx$67--74); el IC 95\% incluye valores por debajo de 70, por
...
FAIR se verifica en \texttt{docs/checklists/fair.md}. Lighthouse reporta 100/95/100/90,
alcanzando los cuatro umbrales, en línea con SPA modernos bien configurados.
...
- Para la operación real en cooperativas, el punto de mejora inmediato es la
  usabilidad (SUS 63): simplificar los formularios de alta/edición.
