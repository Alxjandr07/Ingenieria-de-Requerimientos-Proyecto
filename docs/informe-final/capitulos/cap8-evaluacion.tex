...
\texttt{k04-cold.json}--\texttt{k08-cold.json} (commit \texttt{dea7940}).
...
\texttt{https://sgroas-backend.onrender.com} (commit \texttt{dea7940}).Resultado: 0
...
ejecución de \texttt{./mvnw verify} con 222 pruebas JUnit 5.

\textbf{Datos crudos:} \texttt{docs/mediciones/jacoco/jacoco.csv} y reporte HTML
(commit \texttt{dea7940}, run CI \texttt{34024539023}).

\textbf{Resultado (núcleo, sin paquete \texttt{abd}):} instrucciones 87.5\,\%,
ramas 87.9\,\% y líneas 95.5\,\%, con 0 fallos. Se supera el umbral del proyecto
...
C.4 Cobertura & líneas $\ge$ 70\,\% & 95.5\,\% & Sí \\
