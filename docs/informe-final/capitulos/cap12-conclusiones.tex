...
\begin{itemize}
  ...
  \item \textbf{Cobertura:} núcleo 85,5\,\% líneas / 54,3\,\% ramas (full 67,5\,\% líneas) con JaCoCo sobre 150 pruebas JUnit, superando el umbral LINE 0,70 / BRANCH 0,50.
  \item \textbf{Calidad web:} Lighthouse 100/95/100/90, cumpliendo los cuatro
        umbrales (80/90/90/90).
\end{itemize}
