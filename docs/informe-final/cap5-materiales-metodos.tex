...
\caption{Desglose Goal-Question-Metric del estudio empírico.}
\label{tab:gqm}\\
\toprule
...
\begin{enumerate}
  \item Se ejecuta \texttt{./mvnw clean verify} que ejecuta las 222 pruebas JUnit 5 y genera el reporte JaCoCo.
