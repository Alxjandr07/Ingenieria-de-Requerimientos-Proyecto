...
La Tabla~\ref{tab:trabajos-relacionados} resume los 10 trabajos incluidos, comparados con SGROAS en las dimensiones relevantes.

\begin{longtable}{@{}p{2.2cm}p{1cm}p{1.8cm}p{1.8cm}p{1.5cm}p{1.5cm}p{2cm}@{}}
\caption{Trabajos relacionados y comparación con SGROAS.}
