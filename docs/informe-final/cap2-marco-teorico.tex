...
\begin{itemize}
  \item \textbf{Cobertura de pruebas (JaCoCo):} núcleo 85,5\% líneas / 54,3\% ramas (75,8\% instrucciones), full 67,5\% líneas / 30,2\% ramas; \texttt{abd} excluido del \texttt{jacoco:check}.
  \item \textbf{Número de pruebas:} 150 pruebas JUnit 5 (unitarias e de integración).
