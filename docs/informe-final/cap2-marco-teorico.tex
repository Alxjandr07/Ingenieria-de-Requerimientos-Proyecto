...
\begin{itemize}
  \item \textbf{Cobertura de pruebas (JaCoCo):} núcleo 87,5\% instrucciones / 87,9\% ramas / 95,5\% líneas; paquete \texttt{abd} excluido del \texttt{jacoco:check}.
  \item \textbf{Número de pruebas:} 222 pruebas JUnit 5 (unitarias e de integración).
